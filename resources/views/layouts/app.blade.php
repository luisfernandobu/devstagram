                ...
                <nav class="flex gap-2 items-center">
                    @auth
                        <a
                            ...
                            class="flex items-center gap-1 bg-white border p-2 text-gray-600 rounded text-sm uppercase font-bold cursor-pointer hover:bg-gray-50"
                        >
                        ...
                        <p class="font-bold text-gray-600 text-sm">Hola:
